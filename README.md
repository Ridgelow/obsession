...
| Phone `EXPO_PUBLIC_API_URL` | `https://frequency-remains-solely-univ.trycloudflare.com` (no path) |
...
```
EXPO_PUBLIC_API_URL=https://frequency-remains-solely-univ.trycloudflare.com
