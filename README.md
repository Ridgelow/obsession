...
`https://colleges-departments-fellowship-proper.trycloudflare.com/llm/chat/completions`
...
| Phone `EXPO_PUBLIC_API_URL` | `https://colleges-departments-fellowship-proper.trycloudflare.com` (no path) |
...
```
EXPO_PUBLIC_API_URL=https://colleges-departments-fellowship-proper.trycloudflare.com
EXPO_PUBLIC_ELEVENLABS_AGENT_ID=agent_4801m2bbx00he4krmxrfdvyt4x2k
